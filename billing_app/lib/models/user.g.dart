...
const UserSchema = CollectionSchema(
  ...
  properties: {
    ...
    r'googleAccountLinked': PropertySchema(
      id: 3,
      name: r'googleAccountLinked',
      type: IsarType.bool,
    ),
  ...
  indexes: {
    ...
    r'googleAccountLinked': IndexSchema(
      id: 1467646874516240055,
      name: r'googleAccountLinked',
      unique: false,
      replace: false,
      properties: [
...
void _userSerialize(
  ...
  writer.writeBool(offsets[3], object.googleAccountLinked);
...
User _userDeserialize(
  ...
  object.googleAccountLinked = reader.readBool(offsets[3]);
  object.id = id;
...
extension UserQueryWhereSort on QueryBuilder<User, User, QWhere> {
  ...
  QueryBuilder<User, User, QAfterWhere> anyGoogleAccountLinked() {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(
        const IndexWhereClause.any(indexName: r'googleAccountLinked'),
      );
    });
  }
}
...
extension UserQueryWhere on QueryBuilder<User, User, QWhereClause> {
  ...
  QueryBuilder<User, User, QAfterWhereClause> googleAccountLinkedEqualTo(
      bool googleAccountLinked) {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(IndexWhereClause.equalTo(
        indexName: r'googleAccountLinked',
        value: [googleAccountLinked],
      ));
    });
  }

  QueryBuilder<User, User, QAfterWhereClause> googleAccountLinkedNotEqualTo(
      bool googleAccountLinked) {
    return QueryBuilder.apply(this, (query) {
      if (query.whereSort == Sort.asc) {
        return query
            .addWhereClause(IndexWhereClause.between(
              indexName: r'googleAccountLinked',
              lower: [],
              upper: [googleAccountLinked],
              includeUpper: false,
            ))
            .addWhereClause(IndexWhereClause.between(
              indexName: r'googleAccountLinked',
              lower: [googleAccountLinked],
              includeLower: false,
              upper: [],
            ));
      } else {
...
extension UserQueryFilter on QueryBuilder<User, User, QFilterCondition> {
  ...
  QueryBuilder<User, User, QAfterFilterCondition> googleAccountIdIsNull() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<User, User, QAfterFilterCondition> googleAccountIdIsNotNull() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<User, User, QAfterFilterCondition> googleAccountIdEqualTo(
    String? value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<User, User, QAfterFilterCondition> googleAccountIdGreaterThan(
    String? value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<User, User, QAfterFilterCondition> googleAccountIdLessThan(
    String? value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<User, User, QAfterFilterCondition> googleAccountIdBetween(
    String? lower,
    String? upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<User, User, QAfterFilterCondition> googleAccountIdStartsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<User, User, QAfterFilterCondition> googleAccountIdEndsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<User, User, QAfterFilterCondition> googleAccountIdContains(
      String value,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.contains(
  ...
  QueryBuilder<User, User, QAfterFilterCondition> googleAccountIdMatches(
      String pattern,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.matches(
  ...
  QueryBuilder<User, User, QAfterFilterCondition> googleAccountIdIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'googleAccountId',
        value: '',
  ...
  QueryBuilder<User, User, QAfterFilterCondition> googleAccountIdIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.greaterThan(
        property: r'googleAccountId',
        value: '',
  ...
  QueryBuilder<User, User, QAfterFilterCondition> googleAccountLinkedEqualTo(
      bool value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'googleAccountLinked',
        value: value,
      ));
    });
  }
...
extension UserQuerySortBy on QueryBuilder<User, User, QSortBy> {
  ...
  QueryBuilder<User, User, QAfterSortBy> sortByGoogleAccountId() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'googleAccountId', Sort.asc);
    });
  }

  QueryBuilder<User, User, QAfterSortBy> sortByGoogleAccountIdDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'googleAccountId', Sort.desc);
    });
  }

  QueryBuilder<User, User, QAfterSortBy> sortByGoogleAccountLinked() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'googleAccountLinked', Sort.asc);
    });
  }

  QueryBuilder<User, User, QAfterSortBy> sortByGoogleAccountLinkedDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'googleAccountLinked', Sort.desc);
    });
  }
...
extension UserQuerySortThenBy on QueryBuilder<User, User, QSortThenBy> {
  ...
  QueryBuilder<User, User, QAfterSortBy> thenByGoogleAccountId() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'googleAccountId', Sort.asc);
    });
  }

  QueryBuilder<User, User, QAfterSortBy> thenByGoogleAccountIdDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'googleAccountId', Sort.desc);
    });
  }

  QueryBuilder<User, User, QAfterSortBy> thenByGoogleAccountLinked() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'googleAccountLinked', Sort.asc);
    });
  }

  QueryBuilder<User, User, QAfterSortBy> thenByGoogleAccountLinkedDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'googleAccountLinked', Sort.desc);
    });
  }
...
extension UserQueryWhereDistinct on QueryBuilder<User, User, QDistinct> {
  ...
  QueryBuilder<User, User, QDistinct> distinctByGoogleAccountId(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<User, User, QDistinct> distinctByGoogleAccountLinked() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'googleAccountLinked');
    });
  }
...
extension UserQueryProperty on QueryBuilder<User, User, QQueryProperty> {
  ...
  QueryBuilder<User, String?, QQueryOperations> googleAccountIdProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'googleAccountId');
    });
  }

  QueryBuilder<User, bool, QQueryOperations> googleAccountLinkedProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'googleAccountLinked');
    });
  }
