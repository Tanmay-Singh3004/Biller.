...
void _itemSerialize(
  ...
  writer.writeLong(offsets[2], object.linkedRegisterId);
...
Item _itemDeserialize(
  ...
  object.id = id;
  object.linkedRegisterId = reader.readLong(offsets[2]);
...
extension ItemQueryWhereSort on QueryBuilder<Item, Item, QWhere> {
  ...
  QueryBuilder<Item, Item, QAfterWhere> anyLinkedRegisterId() {
    return QueryBuilder.apply(this, (query) {
...
extension ItemQueryWhere on QueryBuilder<Item, Item, QWhereClause> {
  ...
  QueryBuilder<Item, Item, QAfterWhereClause> linkedRegisterIdEqualTo(
  ...
  QueryBuilder<Item, Item, QAfterWhereClause> linkedRegisterIdNotEqualTo(
      int linkedRegisterId) {
    return QueryBuilder.apply(this, (query) {
      if (query.whereSort == Sort.asc) {
        return query
  ...
  QueryBuilder<Item, Item, QAfterWhereClause> linkedRegisterIdGreaterThan(
    int linkedRegisterId, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Item, Item, QAfterWhereClause> linkedRegisterIdLessThan(
    int linkedRegisterId, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Item, Item, QAfterWhereClause> linkedRegisterIdBetween(
...
extension ItemQueryFilter on QueryBuilder<Item, Item, QFilterCondition> {
  ...
  QueryBuilder<Item, Item, QAfterFilterCondition> linkedRegisterIdEqualTo(
      int value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
  ...
  QueryBuilder<Item, Item, QAfterFilterCondition> linkedRegisterIdGreaterThan(
    int value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Item, Item, QAfterFilterCondition> linkedRegisterIdLessThan(
    int value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Item, Item, QAfterFilterCondition> linkedRegisterIdBetween(
    int lower,
    int upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension ItemQuerySortBy on QueryBuilder<Item, Item, QSortBy> {
  ...
  QueryBuilder<Item, Item, QAfterSortBy> sortByLinkedRegisterId() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'linkedRegisterId', Sort.asc);
    });
  }

  QueryBuilder<Item, Item, QAfterSortBy> sortByLinkedRegisterIdDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension ItemQuerySortThenBy on QueryBuilder<Item, Item, QSortThenBy> {
  ...
  QueryBuilder<Item, Item, QAfterSortBy> thenByLinkedRegisterId() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'linkedRegisterId', Sort.asc);
    });
  }

  QueryBuilder<Item, Item, QAfterSortBy> thenByLinkedRegisterIdDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'linkedRegisterId', Sort.desc);
    });
  }
...
extension ItemQueryWhereDistinct on QueryBuilder<Item, Item, QDistinct> {
  ...
  QueryBuilder<Item, Item, QDistinct> distinctByLinkedRegisterId() {
    return QueryBuilder.apply(this, (query) {
...
extension ItemQueryProperty on QueryBuilder<Item, Item, QQueryProperty> {
  ...
  QueryBuilder<Item, int, QQueryOperations> linkedRegisterIdProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Item, int, QQueryOperations> stockQuantityProperty() {
    return QueryBuilder.apply(this, (query) {
