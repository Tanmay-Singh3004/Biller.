...
const CustomerSchema = CollectionSchema(
  ...
  properties: {
    ...
    r'linkedRegisterId': PropertySchema(
      id: 3,
      name: r'linkedRegisterId',
      type: IsarType.long,
    ),
  ...
  indexes: {
    ...
    r'linkedRegisterId': IndexSchema(
      id: 4299846494090297040,
      name: r'linkedRegisterId',
      unique: false,
      replace: false,
      properties: [
...
void _customerSerialize(
  ...
  writer.writeLong(offsets[3], object.linkedRegisterId);
  writer.writeString(offsets[4], object.name);
  writer.writeDouble(offsets[5], object.outstandingBalance);
...
Customer _customerDeserialize(
  ...
  object.id = id;
  object.linkedRegisterId = reader.readLong(offsets[3]);
  object.name = reader.readString(offsets[4]);
  object.outstandingBalance = reader.readDouble(offsets[5]);
...
extension CustomerQueryWhereSort on QueryBuilder<Customer, Customer, QWhere> {
  ...
  QueryBuilder<Customer, Customer, QAfterWhere> anyLinkedRegisterId() {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(
        const IndexWhereClause.any(indexName: r'linkedRegisterId'),
      );
    });
  }
}
...
extension CustomerQueryWhere on QueryBuilder<Customer, Customer, QWhereClause> {
  ...
  QueryBuilder<Customer, Customer, QAfterWhereClause> linkedRegisterIdEqualTo(
      int linkedRegisterId) {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(IndexWhereClause.equalTo(
        indexName: r'linkedRegisterId',
        value: [linkedRegisterId],
      ));
    });
  }

  QueryBuilder<Customer, Customer, QAfterWhereClause>
      linkedRegisterIdNotEqualTo(int linkedRegisterId) {
    return QueryBuilder.apply(this, (query) {
      if (query.whereSort == Sort.asc) {
        return query
            .addWhereClause(IndexWhereClause.between(
              indexName: r'linkedRegisterId',
              lower: [],
              upper: [linkedRegisterId],
              includeUpper: false,
            ))
            .addWhereClause(IndexWhereClause.between(
              indexName: r'linkedRegisterId',
              lower: [linkedRegisterId],
              includeLower: false,
              upper: [],
            ));
      } else {
  ...
  QueryBuilder<Customer, Customer, QAfterWhereClause> linkedRegisterIdLessThan(
    int linkedRegisterId, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Customer, Customer, QAfterWhereClause> linkedRegisterIdBetween(
    int lowerLinkedRegisterId,
    int upperLinkedRegisterId, {
    bool includeLower = true,
    bool includeUpper = true,
  }) {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(IndexWhereClause.between(
        indexName: r'linkedRegisterId',
        lower: [lowerLinkedRegisterId],
        includeLower: includeLower,
        upper: [upperLinkedRegisterId],
        includeUpper: includeUpper,
      ));
    });
  }
...
extension CustomerQueryFilter
  ...
  QueryBuilder<Customer, Customer, QAfterFilterCondition>
      linkedRegisterIdEqualTo(int value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'linkedRegisterId',
        value: value,
      ));
    });
  }
...
extension CustomerQuerySortBy on QueryBuilder<Customer, Customer, QSortBy> {
  ...
  QueryBuilder<Customer, Customer, QAfterSortBy> sortByLinkedRegisterId() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'linkedRegisterId', Sort.asc);
    });
  }

  QueryBuilder<Customer, Customer, QAfterSortBy> sortByLinkedRegisterIdDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'linkedRegisterId', Sort.desc);
    });
  }
  ...
  QueryBuilder<Customer, Customer, QAfterSortBy> sortByOutstandingBalance() {
    return QueryBuilder.apply(this, (query) {
...
extension CustomerQuerySortThenBy
  ...
  QueryBuilder<Customer, Customer, QAfterSortBy> thenByLinkedRegisterId() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'linkedRegisterId', Sort.asc);
    });
  }

  QueryBuilder<Customer, Customer, QAfterSortBy> thenByLinkedRegisterIdDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'linkedRegisterId', Sort.desc);
    });
  }
  ...
  QueryBuilder<Customer, Customer, QAfterSortBy> thenByOutstandingBalance() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'outstandingBalance', Sort.asc);
    });
  }
...
extension CustomerQueryWhereDistinct
  ...
  QueryBuilder<Customer, Customer, QDistinct> distinctByLinkedRegisterId() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'linkedRegisterId');
    });
  }
  ...
  QueryBuilder<Customer, Customer, QDistinct> distinctByOutstandingBalance() {
    return QueryBuilder.apply(this, (query) {
...
extension CustomerQueryProperty
  ...
  QueryBuilder<Customer, int, QQueryOperations> linkedRegisterIdProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'linkedRegisterId');
    });
  }
